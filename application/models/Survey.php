    ...
    public function getColumns(): array
    {
        $columns = [
            ...
            [
                ...
                'type'              => 'raw',
                'headerHtmlOptions' => ['class' => 'text-center text-muted text-nowrap'],
                'htmlOptions'       => ['class' => 'text-center text-muted'],
            ],
            [
                'header'            => gT('Title'),
                'name'              => 'title',
                'value' => 'isset($data->defaultlanguage) ? CHtml::link("<strong style=\"font-size:1.05rem; color:#222;\">".flattenText($data->defaultlanguage->surveyls_title)."</strong>", Yii::app()->createUrl("surveyAdministration/view", ["surveyid" => $data->sid])) : ""',
                'type'              => 'raw',
            ...
            [
                ...
                'name'   => 'running',
                'value' => '$data->active === "Y"
                    ? "<span style=\"display:inline-block;padding:0.3em 0.6em;font-size:0.75rem;font-weight:600;color:#fff;background-color:#198754;border-radius:0.4rem;\">".gT("Active")."</span>"
                    : "<span style=\"display:inline-block;padding:0.3em 0.6em;font-size:0.75rem;font-weight:600;color:#fff;background-color:#6c757d;border-radius:0.4rem;\">".gT("Inactive")."</span>"',
                'type'   => 'raw',
                'headerHtmlOptions' => ['class' => 'text-nowrap'],
