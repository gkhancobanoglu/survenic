...
<nav class="navbar navbar-expand-md">
    <div class="container-fluid">
        ...
        <a class="navbar-brand d-flex align-items-center" href="<?php echo $this->createUrl("/admin/"); ?>">
            <img src="<?= Yii::app()->baseUrl ?>/assets/images/survenic-logo.png" height="48" class="d-inline-block align-bottom me-2" alt="Survenic Logo">
            <span class="navbar-logo-text">Survenic</span>
        </a>
        <!-- Only on xs screens -->
