...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo Yii::app()->getConfig('styleurl'); ?>survenic.ico" type="image/x-icon"/>
    <link rel="icon" href="<?php echo Yii::app()->getConfig('styleurl'); ?>survenic.ico" type="image/x-icon"/>
    <?php
    $script = "$(function() {
        $('.on').animate({
                    color: '#0B55C4'
    ...
    ?>
    <link rel="icon" href="<?php echo Yii::app()->baseUrl; ?>/images/survenic.ico"/>
