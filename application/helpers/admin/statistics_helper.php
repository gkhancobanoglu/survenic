...
class statistics_helper
{
            ...
            */
            ...
            switch ($outputType) {
                ...
                case 'html':
                    ...
                    . "\t<thead><tr><th colspan='2' class='grouped-header' style='text-align: center;'><strong>" . htmlspecialchars($qquestion) . "</strong></th></tr>\n"
    ...
    protected function displayResults($outputs, $results, $rt, $outputType, $surveyid, $sql, $usegraph, $browse, $sLanguage)
    {
        ...
        switch ($outputType) {
            case 'xls':
                $xlsTitle = sprintf(gT("Summary for %s"), html_entity_decode((string) $outputs['qquestion'], ENT_QUOTES, 'UTF-8'));
            ...
            case 'pdf':
                ...
                $pdfTitle = $this->pdf->delete_html(sprintf(gT("Summary for %s"), html_entity_decode((string) $outputs['qquestion'], ENT_QUOTES, 'UTF-8')));
